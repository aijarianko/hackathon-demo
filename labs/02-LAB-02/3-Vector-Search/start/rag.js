...
async function ragWithVectorsearch(
  ...
  const systemPrompt = `
        You are a helpful, fun and friendly sales assistant for Kmart store.
        Your name is Cosmo.
        You are designed to answer questions about the products that Kmart sells.
